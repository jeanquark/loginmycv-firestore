<template>
	...
	>
		...
		>
			<v-list
			    dense
			    v-if="loadedUser && loadedUser.private"
			>
				<v-list-tile
				    avatar
				    class="my-2"
				...
				<v-list-tile
				    ...
				    to="/admin"
				    v-ripple
				    v-if="loadedUser.status && loadedUser.status.slug === 'admin'"
				>
					<v-list-tile-action>
		...
		>
			...
			<v-btn
			    ...
			    v-if="loadedUser && loadedUser.status && loadedUser.status.slug === 'admin'"
			>Admin</v-btn>
			<div
			    class="hidden-xs-only"
			    v-if="loadedUser && loadedUser.private"
		...
		<v-content>
			...
			>
				...
				>
					...
					>
						<Login
						    v-on:switchToRegisterModal="switchToRegister"
						    v-on:switchToForgotPasswordModal="switchToForgotPassword"
					...
					>
						<Register
						    v-on:switchToLoginModal="switchToLogin"
						    v-on:closeRegisterModal="closeRegisterModal"
						/>
					</v-dialog>

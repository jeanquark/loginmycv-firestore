    ...
    <v-app id="app" v-cloak>
        ...
        <v-toolbar app dark color="primary">
            ...
            <nuxt-link to="/">
				...
				<v-row align="center">
                    <v-img src="/images/logo_small.png" width="40"></v-img>&nbsp;
        ...
        <v-footer height="auto" color="primary lighten-1" app v-if="showFooter">
			...
			<v-row justify="center">
                <v-btn v-for="(link, index) in links" :key="index" color="white" text rounded :to="link.link">
                    {{ link.name }}
                </v-btn>
                <!-- <v-flex primary lighten-2 py-3 text-xs-center white--text xs12> -->
				<v-col primary lighten-2 py-3 text-center white--text>

<template>
    <div class="text-center pa-4" style="margin-top: 0px;" v-if="userResume">
        ...
        <v-row no-gutters justify="center" class="pa-3">
            <v-alert :value="true" color="warning" icon="mdi-exclamation" outlined v-if="!userResume.skills || userResume.skills.length < 1">
            ...
            <v-dialog v-model="modalNewSkill" width="500" persistent>
                <v-card>
                    ...
                    <v-card-text>
                        ...
                        <v-row no-gutters>
                            <!-- <v-flex xs12> -->
                            <v-col cols="12">
                                <v-text-field label="Skill name" name="skill_name" v-validate="{ required: true, max: 50 }" :error-messages="errors ? errors.collect('skill_name') : null" data-vv-as="Skill name" v-model="newSkill.name" :counter="50"></v-text-field>
                                <!-- </v-flex> -->
                            </v-col>

                            <!-- <v-flex xs12> -->
                            <v-col cols="12">
                                <v-select label="Category" :items="userSkillsCategories" no-data-text="No category available. Add one below." v-model="newSkill.category"></v-select>
                                <!-- </v-flex> -->
                            </v-col>

                            <!-- <v-flex xs12> -->
                            <v-col cols="12">
                                <v-slider label="Skill Value" :max="100" :min="0" :step="10" v-model="newSkill.value" color="secondary"></v-slider>
                        ...
                        <v-row no-gutters justify="center">
                            ...
                            <v-col cols="12" class="text-center">
                                <v-radio-group row v-model="newSkill.type" class="justify-center">
                                    <v-radio label="Pie" value="pie" color="secondary"></v-radio>
                        ...
                        <v-row no-gutters align="center">
                            <!-- <v-flex xs8> -->
                            <v-col xs="8">
                                <v-text-field label="Category name" name="category_name" v-validate="{ max: 50 }" :error-messages="errors ? errors.collect('category_name') : null" data-vv-as="Category name" v-model="newSkillCategory" :counter="50"></v-text-field>
                                <!-- </v-flex> -->
                            </v-col>
                            <!-- <v-flex xs4> -->
                            <v-col xs="4">
            ...
            <v-expansion-panels>
                <v-expansion-panel>
                    ...
                    <v-expansion-panel-content v-for="(skill, index) in candidateSkills" :key="index">
                        <div slot="header">
                            ...
                            <v-card-text style="background: black; margin-bottom: 30px;">
                                ...
                                <v-row no-gutters>
                                    ...
                                    <v-col xs="12" sm="6" class="pa-3">
                                        <v-text-field label="Skill name" :name="`skill_name_${index}`" v-validate="{ required: true, max: 50 }" :error-messages="errors ? errors.collect(`skill_name_${index}`) : null" data-vv-as="Skill name" v-model="candidateSkills[index].name" :counter="50"></v-text-field>
                                        <!-- </v-flex> -->
                                    </v-col>

                                    <!-- <v-flex xs12 sm6 class="pa-3"> -->
                                    <v-col xs="12" sm="6" class="pa-3">
                                        <v-select label="Skill Category" v-model="candidateSkills[index].category" no-data-text="No category available. Add one below." :items="userSkillsCategories"></v-select>
                                        <!-- </v-flex> -->
                                    </v-col>

                                    <!-- <v-flex xs12 sm6 class="pa-3"> -->
                                    <v-col xs="12" sm="6" class="pa-3">
                                        <v-slider v-model="candidateSkills[index].value" label="Skill Value" :max="candidateSkills[index].maxValue ? candidateSkills[index].maxValue : 100" :min="0" :step="candidateSkills[index].maxValue ? candidateSkills[index].maxValue/10 : 10" color="secondary"></v-slider>
                                        <div class="text-center">
                                ...
                                <v-row no-gutters align="center" class="pa-3">
                                    <!-- <v-flex xs8 sm4> -->
                                    <v-col xs="8" sm="4">
                                        <v-text-field label="Category name" :name="`category_name_${index}`" v-validate="{ max: 50 }" :error-messages="errors ? errors.collect(`category_name_${index}`) : null" data-vv-as="Category name" v-model="newSkillCategory" :counter="50"></v-text-field>
                                        <!-- </v-flex> -->
                                    </v-col>
                                    <!-- <v-flex xs4 sm2> -->
                                    <v-col xs="4" sm="2">
